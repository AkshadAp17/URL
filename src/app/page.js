      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Transform long URLs into short, manageable links. Track clicks and analyze your link performance with our powerful dashboard.
          </p>
        </div>
        ...
        <div className="mt-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Track clicks, analyze traffic, and understand your audience</p>
            </div>
